...
namespace librule
{
    public struct TokenColor : IEquatable<TokenColor>
    {
        ...
        {
            return obj is TokenColor && Equals((TokenColor)obj);
        }
        ...
        public static TokenColor Lerp(TokenColor value1, TokenColor value2, float amount)
        {
        ...
        public static TokenColor LerpPrecise(TokenColor value1, TokenColor value2, float amount)
        {
            amount = Helper.Clamp(amount, 0, 1);
            return new TokenColor(
