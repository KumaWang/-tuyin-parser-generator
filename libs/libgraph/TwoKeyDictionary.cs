namespace System.Collections.Generic
{
    ...
    class TwoKeyDictionary<PK, SK, V> : IEnumerable<ThreeValue<PK, SK, V>>
    {
        Dictionary<PK, Dictionary<SK, V>> dic_pk;

        public bool Remove(PK first) 
        {
            return dic_pk.Remove(first);
        }
        ...
        internal Dictionary<SK, V> GetDictionary2(PK x)
        {
            return dic_pk[x];
        }
    }
