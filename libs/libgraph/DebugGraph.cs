...
namespace libgraph
{
    public class DebugGraph : IGraph<DebugVertex, DebugEdge>
    {
        ...
        public IEnumerable<DebugVertex> States => Edges.Select(x => x.Target).Union(Edges.Select(x => x.Source)).Distinct();
