...
namespace LLParserLexerLib
{
	...
	public class SourceTrackable : ISourceTrackable
	{
		...
		public int Start { get { return _startNu; } }

		public int End { get { return _endNu; } }
	...
	public class TokenAST : SourceTrackable, IAST
	{
		...
		public TokenAST(ISourceTrackable sc, int tk, string id, string v) : this(sc.fileName, sc.lineNu, tk, id, v, sc.Start, sc.End) {}
	...
	abstract class ParserBase
	{
		...
		protected virtual TokenAST Match(int ch, object v)
		{
			if (Next.token != ch)
